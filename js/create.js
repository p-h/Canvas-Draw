	...
	//Canvas Element und Context holen
	 ...
	 var pen = {
	 	...
	 	touchstart: function(position){
	 		context.beginPath(); //Der Path wird begonnen.
	 		context.moveTo(position.x, position.y); //Startposition wird auf die geholten Koordinaten gesetzt.
	 		this.isDrawing=true; //Der User zeichnet jetzt, also ist isDrawing nun true.
	 	},
